...
if start==0
    ...
    lambda = systemeigen(u,p,pbar,aexp, amp, freq, t); dt = CFL / lambda; % calculate eigenvalue and use to get initial dt
end
...
for i = start:totalTime
    ...
    lambda = systemeigen(u,p,pbar,aexp, amp, freq, t); % get new eigenvalue
    ...
    [f1,f2] = flux(u,p,pbar,aexp, amp, freq, t); % calculate flux
